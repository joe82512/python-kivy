...
LabelBase.register(name='Sans',
    fn_regular = 'data/fonts/TaipeiSans.ttf',
)
...
class CheckPwd(Screen):
    def __init__(self, **kwargs):
        ...
        self.ids.now_pwd.text = '[color=#3f72af]' + pwd_show + '[/color]'
        self.bar_start()
...
if __name__ == "__main__":
    ...
    print(resource_find('data/fonts'))
    print(resource_find('data/style.kv'))
    demo_app = DemoApp()
    demo_app.run()